...
import torch
from dataset_loader import VisualAudioDataSet
import time
...
## python train_interact_urban8k_spike_net_amp.py --model_scale S --train_data UrbanSound8K-AV --dataset_path ./UrbanSound8K-AV --t_step 5 --epoch 30 --n_mels 64 --batch_size 16 --pool_kern_size 8 --lr 1e-3 --fusion_method concat 
## python train_interact_urban8k_spike_net_amp.py --model_scale S --train_data UrbanSound8K-AV --dataset_path ./UrbanSound8K-AV --t_step 5 --epoch 30 --n_mels 64 --batch_size 16 --pool_kern_size 8 --lr 1e-3 --fusion_method sum
## python train_interact_urban8k_spike_net_amp.py --model_scale S --train_data UrbanSound8K-AV --dataset_path ./UrbanSound8K-AV --t_step 5 --epoch 30 --n_mels 64 --batch_size 16 --pool_kern_size 8 --lr 1e-3 --fusion_method ew
## python train_interact_urban8k_spike_net_amp.py --model_scale S --train_data UrbanSound8K-AV --dataset_path ./UrbanSound8K-AV --t_step 5 --epoch 30 --n_mels 64 --batch_size 16 --pool_kern_size 8 --lr 1e-3 --fusion_method att
## python train_interact_urban8k_spike_net_amp.py --model_scale S --train_data UrbanSound8K-AV --dataset_path ./UrbanSound8K-AV --t_step 5 --epoch 10 --n_mels 64 --batch_size 16 --pool_kern_size 8 --lr 1e-3 --fusion_method sum --load_trained_model UrbanSound8K-AV_S_sum_save_best_model.pth
...
dataset = VisualAudioDataSet(args.dataset_path, transform=transform, audio_transform=audio_transforms)
...
if args.model_scale == 'S':
    net = InteractSpikeNet_S(pool_kernel_size=args.pool_kern_size,input_width=args.n_mels,in_channels=[3,1],num_classes=10,connect_f='ADD',fusion_f=args.fusion_method)
elif args.model_scale == 'XS':
    net = InteractSpikeNet_XS(pool_kernel_size=args.pool_kern_size,input_width=args.n_mels,in_channels=[3,1],num_classes=10,connect_f='ADD',fusion_f=args.fusion_method)
        ...
        for img1, img2, label in train_loader:
            ...
            with autocast():
                ...
                for t in range(args.t_step):
                    out_fr,out_fr1,out_fr2 = net(img1, img2)
                    out_fr += out_fr
                    out_fr1 += out_fr1
                    out_fr2 += out_fr2
