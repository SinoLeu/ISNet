...
class SEWPreActBottleneck(nn.Module):
...
class VAMutilSpikingResNet(nn.Module):
    def __init__(self,spiking_resnet,neuron_model,neuron_dropout=0.3):
        super(VAMutilSpikingResNet, self).__init__()

        self.neuron_model = neuron_model
        self.spiking_net = spiking_resnet(neuron=self.neuron_model,neuron_dropout=neuron_dropout,c_in=4)
