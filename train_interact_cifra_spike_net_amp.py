...
import torch
from dataset_loader2 import VisualAudioDataSet
import time
...
## python train_interact_spike_net_amp.py --model_scale S --train_data UrbanSound8K-AV --dataset_path ./UrbanSound8K-AV --t_step 5 --epoch 30 --n_mels 64 --batch_size 16 --pool_kern_size 8 --lr 1e-3 --fusion_method sum
## python train_interact_spike_net_amp.py --model_scale S --train_data UrbanSound8K-AV --dataset_path ./UrbanSound8K-AV --t_step 5 --epoch 30 --n_mels 64 --batch_size 16 --pool_kern_size 8 --lr 1e-3 --fusion_method ew
## python train_interact_spike_net_amp.py --model_scale S --train_data UrbanSound8K-AV --dataset_path ./UrbanSound8K-AV --t_step 5 --epoch 30 --n_mels 64 --batch_size 16 --pool_kern_size 8 --lr 1e-3 --fusion_method att
